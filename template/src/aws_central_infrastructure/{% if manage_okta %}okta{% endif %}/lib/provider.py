...
from lab_auto_pulumi.constants import IAC_DEPLOY_TOKENS_SECRETS_PREFIX
from lab_auto_pulumi.constants import IAC_PREVIEW_TOKEN_SECRETS_PREFIX
from pulumi.runtime import is_dry_run
from pulumi_okta import Provider

OKTA_DEPLOY_TOKEN_SECRET_NAME = f"{IAC_DEPLOY_TOKENS_SECRETS_PREFIX}/okta-access-token"
OKTA_PREVIEW_TOKEN_SECRET_NAME = f"{IAC_PREVIEW_TOKEN_SECRETS_PREFIX}/okta-access-token"
